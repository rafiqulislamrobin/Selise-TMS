...
namespace TMS.Application.Entities
{
    ...
    public class Task : Entity<int>, IAudit
    {
        ...
        public Task(string title, string description, TaskStatus status, int assignedToUserId, int createdUserId, int teamId, DateTime dueDate)
        {
            Title = title;
        ...
        public void Update(string title, string description, TaskStatus status, int assignedToUserId, int teamId, DateTime dueDate)
        {
            Title = title;
            Description = description;
            Status = status;
