...
using Post = TMS.Application.features.Task.Post;
using Task = TMS.Application.Entities.Task;

namespace TMS.Infrastructure.Repositories
{
    public class TaskRepository : Get.IRepository, Post.IRepository
    {
        ...
        {
          var users = _dbContext.Users.Where(u => u.Id == Id).FirstOrDefault();
            return users;
        }
    }
}
