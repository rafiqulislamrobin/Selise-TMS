...
using TaskPost = TMS.Application.features.Task.Post;
...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    .WriteTo.File("Logs/tms-log-.txt", rollingInterval: RollingInterval.Day)
    .CreateLogger();
...
builder.Services.AddScoped<TaskPost.IRepository, TaskRepository>();
...
.AddJwtBearer(options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        // ? This ensures ASP.NET maps the role claim correctly
        RoleClaimType = ClaimTypes.Role, // <- this is needed
